...
#' * tcga_wgbs_hg38 : WGBS Data (CpG sites only) from 39 bladder, breast, colon, glioblastoma, lung, rectal stomach and uterine tumour samples and and 8 matching normal samples from "Zhou, Wanding, et al. "DNA methylation loss in late-replicating domains is linked to mitotic cell division." Nature genetics 50.4 (2018): 591-602." 
